...
const cardThemes: Record<string, Partial<CardTheme>> = {
  glue: {
    ...
    artBg: "#EEFF8C",
    artBorder: "#586605",
    artImage: "/images/glue-card-art.svg",
  ...
  spark: {
    ...
    artBg: "#FFD6E0",
    artBorder: "#D4587A",
    artImage: "/images/spark-card-art.svg",
  ...
  flex: {
    ...
    artBg: "#DDE8E0",
    artBorder: "#7BA38A",
    artImage: "/images/flex-card-art.svg",
  ...
  heart: {
    ...
    artBg: "#F5D6F5",
    artBorder: "#C87AC8",
    artImage: "/images/heart-card-art.svg",
  ...
  craft: {
    ...
    artBg: "#DDD3F2",
    artBorder: "#8B7ABF",
    artImage: "/images/craft-card-art.svg",
  ...
  maverick: {
    ...
    artBg: "#D6D6FF",
    artBorder: "#8B8BCC",
    artImage: "/images/maverick-card-art.svg",
  ...
  vision: {
    ...
    artBg: "#CCE8F5",
    artBorder: "#6AAFCC",
    artImage: "/images/vision-card-art.svg",
