...
export const icQuestions: Question[] = [
  {
    ...
    options: [
      { id: "a", text: "Ship it now. Real-world feedback beats perfect planning.", signals: ["spark"] },
      { id: "b", text: "Hold it until it\u2019s ready. I don\u2019t publish anything below my standards.", signals: ["craft"] },
      { id: "c", text: "Rally the team to make one last pass. We\u2019re in this together.", signals: ["heart"] },
      { id: "d", text: "Stay up late to get it over the finish line. I do whatever it takes.", signals: ["flex"] },
      { id: "e", text: "Spin up a new AI workflow to refine and finalize.", signals: ["maverick"] }
    ]
  },
  {
    id: "q3",
    ...
    options: [
      { id: "a", text: "AI handles 80% of the work, I finish up. Speed is the most important.", signals: ["spark"] },
      { id: "b", text: "I\u2019m constantly running new tools and playbooks. Experimentation is my edge.", signals: ["maverick"] },
      { id: "c", text: "I\u2019m learning something new every week, but not an expert. This stuff is exciting.", signals: ["heart"] },
      { id: "d", text: "I focus on AI that enhances creativity and quality, not just speed.", signals: ["craft"] },
  ...
  },
  {
    ...
    options: [
      { id: "a", text: "I start dreaming up what our unique and creative take is.", signals: ["craft"] },
      { id: "b", text: "I brainstorm a hot take to stir reactions in the market.", signals: ["maverick"] },
      { id: "c", text: "I start thinking about how Product, Sales, and CX could react.", signals: ["flex"] },
      { id: "d", text: "I have systems ready to respond quickly when trends hit.", signals: ["glue"] },
      { id: "e", text: "I move fast. First to market with a post or ad usually wins.", signals: ["spark"] }
    ]
  },
  {
    id: "q5",
    ...
    options: [
      { id: "a", text: "Quality-focused. Every piece should represent the best I can do.", signals: ["craft"] },
      { id: "b", text: "Strategic. I think about how my work connects to bigger goals.", signals: ["vision"] },
      { id: "c", text: "Adaptable. I figure out what each situation needs.", signals: ["flex"] },
      { id: "d", text: "Experimental. I\u2019m always testing new approaches or tools.", signals: ["maverick"] },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "b", text: "I test every new tool hands-on and keep what works for me.", signals: ["maverick"] },
      { id: "c", text: "I adapt my learning based on what projects are coming up.", signals: ["flex"] },
      { id: "d", text: "I\u2019ve built learning routines that keep me consistent.", signals: ["glue"] },
      { id: "e", text: "I learn by doing. I pick up skills as I ship work.", signals: ["spark"] }
    ]
  },
  {
    id: "q7",
    ...
    options: [
      { id: "a", text: "Focus on delivering quickly and efficiently.", signals: ["spark"] },
      { id: "b", text: "Make sure the quality meets standards before sharing anything.", signals: ["craft"] },
      { id: "c", text: "Ask lots of questions to understand what would be most helpful.", signals: ["heart"] },
      { id: "d", text: "Build it, plan an enablement session, and follow up to make sure it\u2019s used.", signals: ["flex"] },
...
export const managerQuestions: Question[] = [
  {
    ...
    options: [
      { id: "a", text: "We ship and learn from feedback. Perfect is the enemy of done.", signals: ["spark"] },
      { id: "b", text: "I run through the process myself to see where things are breaking.", signals: ["flex"] },
      ...
      { id: "e", text: "We experiment with new AI tools for quality control.", signals: ["maverick"] }
    ]
  },
  {
    id: "q3",
    ...
    options: [
      { id: "a", text: "Fast adoption. AI drafts, humans finish. We\u2019re shipping more than ever.", signals: ["spark"] },
      { id: "b", text: "I work with each team member to develop a personalized plan.", signals: ["flex"] },
      ...
      { id: "e", text: "Carefully and slowly. I need to maintain our quality standards as we scale.", signals: ["craft"] }
    ]
  },
  {
    id: "q4",
    ...
    options: [
      { id: "a", text: "I rolled out a new AEO tool last year and we\u2019re experimenting fast.", signals: ["maverick"] },
      { id: "b", text: "I\u2019ve assigned ownership and we\u2019re developing our systematic approach.", signals: ["vision"] },
      { id: "c", text: "I\u2019m talking to a ton of colleagues and peers to come up with the best approach.", signals: ["flex"] },
  ...
  },
  {
    ...
    options: [
      { id: "a", text: "Run it through an LLM to create content and ship our response before the competition.", signals: ["spark"] },
      { id: "b", text: "I adapt our response based on team strengths and the specific trend.", signals: ["flex"] },
  ...
  },
  {
    ...
    options: [
      { id: "a", text: "Adaptive. I meet each team member and situation where they are.", signals: ["flex"] },
      ...
      { id: "d", text: "Experimental. We\u2019re always testing new approaches together.", signals: ["maverick"] },
      { id: "e", text: "Results-driven. We focus on shipping and hitting our goals.", signals: ["spark"] }
    ]
  },
  {
    id: "q7",
    ...
    options: [
      ...
      { id: "c", text: "I encourage them to experiment and try new approaches.", signals: ["maverick"] },
      { id: "d", text: "I create clear processes and training so they can excel consistently.", signals: ["glue"] },
      { id: "e", text: "I push them to maintain high standards in everything they do.", signals: ["craft"] }
    ]
  }
];
...
export const executiveQuestions: Question[] = [
  {
    ...
    options: [
      { id: "a", text: "Rally the team. We have untapped energy to unlock.", signals: ["spark"] },
      { id: "b", text: "Invest in a new AI tool. That\u2019s our force multiplier.", signals: ["maverick"] },
      { id: "c", text: "Restructure priorities to align with the strategic shift.", signals: ["vision"] },
      { id: "d", text: "Think about how to maintain quality as we scale. No compromising brand.", signals: ["craft"] },
  ...
  },
  {
    ...
    options: [
      { id: "a", text: "It\u2019s central to our strategy. We\u2019re building an AI-native operation.", signals: ["maverick"] },
      { id: "b", text: "We\u2019re implementing structured workflows that enable the whole team.", signals: ["glue"] },
      { id: "c", text: "Thoughtful investment. I need clear proof we won\u2019t produce slop as we adopt.", signals: ["craft"] },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "b", text: "We\u2019re testing approaches across segments and use cases.", signals: ["flex"] },
      { id: "c", text: "Making sure we are still building for humans, not just bots.", signals: ["craft"] },
      { id: "d", text: "We\u2019re moving early and aggressively. We can\u2019t miss the competitive advantage.", signals: ["maverick"] },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "b", text: "Brand and quality. Long-term value can help us survive short-term disruption.", signals: ["craft"] },
      { id: "c", text: "Team learning and development. Our team is always getting closer to the win.", signals: ["heart"] },
      { id: "d", text: "Innovation. An experimental attitude wins, despite missteps along the way.", signals: ["maverick"] },
      { id: "e", text: "Adaptability. We\u2019ll win if we are able to constantly assess and adapt.", signals: ["flex"] }
    ]
  },
  {
    id: "q6",
    ...
    options: [
      ...
      { id: "b", text: "Quality-focused. I maintain standards and the organization rises to meet them.", signals: ["craft"] },
      { id: "c", text: "Innovation-driven. We stay ahead by moving early on opportunities.", signals: ["maverick"] },
      { id: "d", text: "Growth-minded. I\u2019m personally invested in building organizational capability.", signals: ["heart"] },
      { id: "e", text: "Adaptive. I read situations and adjust our approach accordingly.", signals: ["flex"] }
    ]
  },
  {
    id: "q7",
    ...
    options: [
      ...
      { id: "d", text: "Talk to other leaders to figure out what\u2019s worked for others.", signals: ["flex"] },
      { id: "e", text: "Focus on the foundations. You know what works. Just execute well.", signals: ["craft"] }
    ]
  }
];
...
export function calculateArchetype(answers: Record<string, string>, role: Role): ArchetypeId {
  ...
  return (topArchetypes[0] as ArchetypeId) || "spark"; // Default fallback
}
