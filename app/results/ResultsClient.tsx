...
export default function ResultsClient() {
  ...
  // LinkedIn: embed the URL in the text so both the post body and link preview populate
  const linkedinPostText = `${shareBody}\n\n${sharePageUrlStr}`;
  const linkedinShareUrl = `https://www.linkedin.com/feed/?shareActive=true&text=${encodeURIComponent(linkedinPostText)}`;
